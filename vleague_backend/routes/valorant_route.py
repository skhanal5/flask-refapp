...
from vleague_backend.models.vlr_orl_api import PreviousResults, UpcomingMatches
...
def get_team(team_name: str) -> dict[str, Any]:
    # TODO: convert team_name => id
    port = get_port()
    return port.get_team("11058")  # hardcoded for testing purposes
...
def get_upcoming_matches(team_name: str) -> list[UpcomingMatches]:
    # TODO: convert team_name => id
    port = get_port()
    return port.get_upcoming_matches("11058")
...
def get_team_results(team_name: str) -> list[PreviousResults]:
    # TODO: convert team_name => id
    port = get_port()
    return port.get_previous_results("11058")
